...
Plataforma para centralizar e orquestrar integrações entre diferentes serviços e APIs — arquitetura de integração, autenticação e tratamento de requisições HTTP entre sistemas.
...
![REST](https://img.shields.io/badge/-REST%20APIs-555555?style=flat-square)
![OAuth](https://img.shields.io/badge/-OAuth-3C3C3D?style=flat-square)
